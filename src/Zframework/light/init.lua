...
local shadowMapShader = gc.newShader("src/ZFramework/light/shadowMap.glsl")--Shader for caculating the 1D shadow map.
local lightRenderShader = gc.newShader("src/ZFramework/light/lightRender.glsl")--Shader for rendering blurred lights and shadows.
