...
function FILE.saveSetting()
    ...
    F:close()
    if _ then
        LOG.print(text.settingSaved, COLOR.green)
    else
        LOG.print(text.settingSavingError .. (mes or "unknown error"), COLOR.red)
    end
end
...
function FILE.saveKeyMap()
    ...
    F:close()
    if _ then
        LOG.print(text.keyMapSaved, COLOR.green)
    else
        LOG.print(text.keyMapSavingError .. (mes or "unknown error"), COLOR.red)
    end
end
...
function FILE.saveVK()
    ...
    F:close()
    if _ then
        LOG.print(text.VKSaved, COLOR.green)
    else
        LOG.print(text.VKSavingError .. (mes or "unknown error"), COLOR.red)
    end
end
return FILE