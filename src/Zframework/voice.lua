...
local function loadVoiceFile(N, vocName)
    local fileName = "/resources/media/VOICE/" .. SETTING.cv .. "/" .. vocName .. ".ogg"
...
function VOC.update()
    for i = #voiceQueue, 1, -1 do
        ...
        if Q.s == 0 then
            --Free channel, auto delete when >3
            if i > 3 then
                rem(voiceQueue, i)
            end
        elseif Q.s == 1 then
