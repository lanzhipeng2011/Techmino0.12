...
return {
    ...
    load = function()
        ...
        local r = P:RND(6)
        if r == 1 then
            F[1][5], F[1][4], F[2][4] = 20, 20, 20
        elseif r == 2 then
            F[1][6], F[1][7], F[2][7] = 20, 20, 20
        elseif r == 3 then
            F[1][4], F[2][4], F[2][5] = 20, 20, 20
        elseif r == 4 then
            F[1][7], F[2][7], F[2][6] = 20, 20, 20
        elseif r == 5 then
            F[1][4], F[1][5], F[1][6] = 20, 20, 20
        elseif r == 6 then
            F[1][7], F[1][6], F[1][5] = 20, 20, 20
        end
    end,
    mesDisp = function(P)
        setFont(45)
    ...
    score = function(P)
        return { min(P.modeData.point, 100), P.stat.time }
    end,
    scoreDisp = function(D)
        return D[1] .. " Combo   " .. toTime(D[2])
    end,
    comp = function(a, b)
