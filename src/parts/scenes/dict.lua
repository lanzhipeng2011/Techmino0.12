...
function sceneInit.dict()
    ...
    sceneTemp = {
        dict = require("resources/languages/dict_" .. location),
...
WIDGET.init("dict", {
    ...
    WIDGET.newKey({ name = "keyboard", x = 960, y = 60, w = 200, h = 80, font = 35, code = function()
        love.keyboard.setTextInput(true, 0, 0, 1, 1)
    end, hide = not MOBILE }),
    WIDGET.newKey({ name = "link", x = 1140, y = 650, w = 200, h = 80, font = 35, code = WIDGET.lnk_pressKey("link"), hide = function()
        return not sceneTemp.url
    end }),
