...
WIDGET.init("main", {
    ...
    WIDGET.newButton({ name = "qplay", x = 590, y = 380, w = 200, h = 140, color = "white", font = 40, code = function()
        SCN.push()
    ...
    WIDGET.newButton({ name = "quit", x = 590, y = 515, w = 200, h = 90, color = "grey", font = 40, code = function()
        VOC.play("bye")
