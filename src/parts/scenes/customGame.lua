...
WIDGET.init("customGame", {
    ...
    WIDGET.newText({ name = "defSeq", x = 330, y = 550, align = "L", color = "grey", hide = function()
        return BAG[1]
    end }),
    WIDGET.newText({ name = "noMsn", x = 610, y = 550, align = "L", color = "grey", hide = function()
        return MISSION[1]
    end }),
    ...
    WIDGET.newSelector({ name = "bgm", x = 1070, y = 230, w = 250, color = "yellow", list = BGM.list, disp = WIDGET.lnk_CUSval("bgm"), code = function(i)
        CUSTOMENV.bgm = i
        BGM.play(i)
    end }),
    ...
    WIDGET.newButton({ name = "puzzle", x = 1070, y = 550, w = 310, h = 70, color = "lMagenta", font = 35, code = WIDGET.lnk_pressKey("return2"), hide = function()
        return not sceneTemp.initField
    end }),
