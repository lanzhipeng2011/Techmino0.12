...
WIDGET.init("sound", {
    ...
    WIDGET.newSlider({ name = "sfx", x = 510, y = 60, w = 330, font = 35, change = function()
        SFX.play("blip_1")
    end, disp = WIDGET.lnk_SETval("sfx"), code = WIDGET.lnk_SETsto("sfx") }),
    WIDGET.newSlider({ name = "voc", x = 510, y = 120, w = 330, font = 35, change = function()
        VOC.play("test")
    end, disp = WIDGET.lnk_SETval("voc"), code = WIDGET.lnk_SETsto("voc") }),

    WIDGET.newKey({ name = "move", x = 110, y = 140, w = 160, h = 50, code = function()
        SFX.play("move")
    end }),
    WIDGET.newKey({ name = "lock", x = 110, y = 205, w = 160, h = 50, code = function()
        SFX.play("lock")
    end }),
    WIDGET.newKey({ name = "drop", x = 110, y = 270, w = 160, h = 50, code = function()
        SFX.play("drop")
    end }),
    WIDGET.newKey({ name = "fall", x = 110, y = 335, w = 160, h = 50, code = function()
        SFX.play("fall")
    end }),
    WIDGET.newKey({ name = "rotate", x = 110, y = 400, w = 160, h = 50, code = function()
        SFX.play("rotate")
    end }),
    WIDGET.newKey({ name = "rotatekick", x = 110, y = 465, w = 160, h = 50, code = function()
        SFX.play("rotatekick")
    end }),
    WIDGET.newKey({ name = "hold", x = 110, y = 530, w = 160, h = 50, code = function()
        SFX.play("hold")
    end }),
    WIDGET.newKey({ name = "prerotate", x = 110, y = 595, w = 160, h = 50, code = function()
        SFX.play("prerotate")
    end }),
    WIDGET.newKey({ name = "prehold", x = 110, y = 660, w = 160, h = 50, code = function()
        SFX.play("prehold")
    end }),

    WIDGET.newKey({ name = "clear1", x = 280, y = 140, w = 160, h = 50, code = function()
        SFX.play("clear_1")
    end }),
    WIDGET.newKey({ name = "clear2", x = 280, y = 205, w = 160, h = 50, code = function()
        SFX.play("clear_2")
    end }),
    WIDGET.newKey({ name = "clear3", x = 280, y = 270, w = 160, h = 50, code = function()
        SFX.play("clear_3")
    end }),
    WIDGET.newKey({ name = "clear4", x = 280, y = 335, w = 160, h = 50, code = function()
        SFX.play("clear_4")
    end }),
    WIDGET.newKey({ name = "spin0", x = 280, y = 400, w = 160, h = 50, code = function()
        SFX.play("spin_0")
    end }),
    WIDGET.newKey({ name = "spin1", x = 280, y = 465, w = 160, h = 50, code = function()
        SFX.play("spin_1")
    end }),
    WIDGET.newKey({ name = "spin2", x = 280, y = 530, w = 160, h = 50, code = function()
        SFX.play("spin_2")
    end }),
    WIDGET.newKey({ name = "spin3", x = 280, y = 595, w = 160, h = 50, code = function()
        SFX.play("spin_3")
    end }),
    WIDGET.newKey({ name = "_pc", x = 280, y = 660, w = 160, h = 50, code = function()
        SFX.play("clear")
    end }),
