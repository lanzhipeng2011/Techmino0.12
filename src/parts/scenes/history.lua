...
function sceneInit.history()
    BG.set("rainbow")
    sceneTemp = {
        text = require("src/parts/updateLog"), --Text list
        pos = 1, --Scroll pos
    }
...
WIDGET.init("history", {
    ...
    WIDGET.newKey({ name = "next", x = 1155, y = 400, w = 180, font = 65, code = WIDGET.lnk_pressKey("down"), hide = function()
        return sceneTemp.pos == #sceneTemp.text
    end }),
