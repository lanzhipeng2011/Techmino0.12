...
WIDGET.init("savedata", {
    WIDGET.newButton({ name = "exportUnlock", x = 190, y = 150, w = 280, h = 100, color = "lGreen", font = 25, code = function()
        encodeCB(RANKS)
    end }),
    WIDGET.newButton({ name = "exportData", x = 490, y = 150, w = 280, h = 100, color = "lGreen", font = 25, code = function()
        encodeCB(STAT)
    end }),
    WIDGET.newButton({ name = "exportSetting", x = 790, y = 150, w = 280, h = 100, color = "lGreen", font = 25, code = function()
        encodeCB(SETTING)
    end }),
    WIDGET.newButton({ name = "exportVK", x = 1090, y = 150, w = 280, h = 100, color = "lGreen", font = 25, code = function()
        encodeCB(VK_org)
    end }),

    WIDGET.newButton({ name = "importUnlock", x = 190, y = 300, w = 280, h = 100, color = "lBlue", font = 25, code = function()
        addToTable(parseCB() or NONE, RANKS)
    end }),
    WIDGET.newButton({ name = "importData", x = 490, y = 300, w = 280, h = 100, color = "lBlue", font = 25, code = function()
        addToTable(parseCB() or NONE, STAT)
    end }),
    WIDGET.newButton({ name = "importSetting", x = 790, y = 300, w = 280, h = 100, color = "lBlue", font = 25, code = function()
        addToTable(parseCB() or NONE, SETTING)
    end }),
    WIDGET.newButton({ name = "importVK", x = 1090, y = 300, w = 280, h = 100, color = "lBlue", font = 25, code = function()
        addToTable(parseCB() or NONE, VK_org)
    end }),
