local Player = require("src/parts/player/player")
local prepareSequence = require("src/parts/player/prepareSequence")
local gameEnv0 = require("src/parts/player/gameEnv0")
...
local PLY = {
    update = require("src/parts/player/update"),
    draw = require("src/parts/player/draw"),
}
...
local function applyGameEnv(P)
    --Finish gameEnv processing
    local ENV = P.gameEnv
    ...
    if ENV.lockFX == 0 then
        ENV.lockFX = nil
    end
    if ENV.dropFX == 0 then
        ENV.dropFX = nil
    end
    if ENV.moveFX == 0 then
        ENV.moveFX = nil
    end
    if ENV.clearFX == 0 then
        ENV.clearFX = nil
    end
    if ENV.shakeFX == 0 then
        ENV.shakeFX = nil
    end
